...
// Acesse o elemento de input do arquivo
let audioFileInput = document.getElementById("audioFile");

// Acesse o elemento de áudio
var relax = document.getElementById("relax");

// Adicione um evento para lidar com a seleção do arquivo
audioFileInput.addEventListener("change", function () {
  // Verifique se um arquivo foi selecionado
  if (audioFileInput.files.length > 0) {
    // Obtenha o arquivo selecionado
    var selectedAudioFile = audioFileInput.files[0];

    // Defina a fonte do áudio para o arquivo selecionado
    relax.src = URL.createObjectURL(selectedAudioFile);
  }
});
